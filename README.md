...
- Configurable assessment counts, maximum marks, weightages, and best-of selection counts
...
- What-if analysis for future PT, NPT, and ST marks
- Target CGPA predictor for the next 1, 2, and 3 trimesters
- PT trend, NPT trend, assessment comparison, contribution, forecast, and heatmap analytics
...
All marks, counts, weightages, and best-of values are editable and saved locally.

## Problem Statement

IIT Guwahati BSc Data Science and AI students need a privacy-preserving academic analytics tool that handles official evaluation rules, curriculum exploration, performance trends, GPA planning, and report generation without uploading marks to a server.
